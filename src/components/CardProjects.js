...
export default function CardProjects({
  ...
  return (
    <div
      className={`w-2/5 h-auto p-5 m-2 border-2 border-neutral-800 rounded-xl flex flex-col ${style.container}`}>
      ...
      <div className={style.imageCard}>
        <Image alt="image of the project" src={image} />
      </div>
      <p className={`text-white text-sm mb-4`}>
        {description}
        {client && linkClient && (
          <a className="text-salmon" href={linkClient} target="_blank">
            {client}
          </a>
        )}
      </p>
        ...
        {linkGithub && (
          <a
            ...
            <Image
              ...
              style={{
                filter: 'invert(1)',
                transform: githubHovered ? 'scale(1.1)' : 'scale(1)',
              }}
            />
          </a>
        )}
        {linkDeploy && (
          <a
            ...
            <Image
              ...
              style={{
                filter: 'invert(1)',
                transform: deployHovered ? 'scale(1.1)' : 'scale(1)',
              }}
            />
          </a>
        )}
